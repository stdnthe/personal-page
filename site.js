const copy = {
  zh: {
    ...
    heroTitle: "把业务问题变成可验证的 AI 数据产品",
    heroLede:
      "我是一名关注增长分析、AI 产品分析和大模型评测的数据科学从业者，喜欢把复杂业务问题转化为数据洞察和实用的 AI 分析产品。",
  ...
  en: {
    ...
    navContact: "Contact",
    heroEyebrow: "Growth Analytics / AI Product Analytics / LLM Evaluation",
    heroTitle: "Turning business problems into verifiable AI data products",
    heroLede:
      "I am a data scientist focused on growth analytics, AI product analytics, and LLM evaluation. I enjoy turning complex business problems into data-driven insights and practical AI-powered analytics products.",
    chipOne: "Growth Analytics",
    chipTwo: "AI Product Analytics",
    chipThree: "LLM Evaluation",
