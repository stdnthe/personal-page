const copy = {
  zh: {
    ...
    navAbout: "About",
    navContact: "Contact",
    heroEyebrow: "AI Evals / Data Product / LLM Notes",
    heroTitle: "Hi，我是 Jiaqi He。",
    heroLede:
      "我关注 AI 评测、数据产品和大模型科普，喜欢把复杂业务问题拆成可验证的数据判断，再写成清楚、可复用的分析笔记。",
    chipOne: "AI Evaluation",
    chipTwo: "Data Product",
    chipThree: "LLM Explainers",
    heroPrimary: "读文章",
    heroSecondary: "Start Here",
    ...
    seriesThreeLabel: "Coming next",
    seriesThreeTitle: "Data Product 实践",
    seriesThreeBody: "把数据分析、增长问题和 AI 工作流整理成产品化思考。",
    aboutDetailTitle: "教育、CQF、技能标签",
  ...
  en: {
    ...
    heroLede:
      "I write about AI evaluation, data products, and LLM fundamentals, turning messy business questions into verifiable analytical judgment.",
    chipOne: "AI Evaluation",
    chipTwo: "Data Product",
    chipThree: "LLM Explainers",
    heroPrimary: "Read blogs",
    heroSecondary: "Start Here",
    photoCaption: "Snowboard, data, and models: all require feedback from reality.",
    profileLabel: "Current focus",
    profileBody: "AI evaluation, analytics workflows, and practical LLM explainers.",
    ...
    seriesThreeBody: "Product-minded notes on analytics, growth questions, and AI workflows.",
    aboutDetailTitle: "Background and foundations",
